...
namespace MFRCConfig
{
    ...
    bool SaveConfig()
    {
        DeviceType deviceType1 = DeviceType::Source;
        TeamColor teamColor1 = TeamColor::RED;

        // TODO: SERIALIZE OR FIND A WORKAROUND

        char* data = "{\"NETSSID\":\"BK_School\",\"NETPW\":\"8K-$cH0oL!\",\"SecurityKey\":16777216,\"FMSIP\":[10,134,100,230],\"FMSPort\":8081,\"teamColor1\":1,\"deviceType1\":3,\"teamColor2\":0,\"deviceType2\":0}";
